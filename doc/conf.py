# -*- coding: utf-8 -*-
#
# ximpol documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../ximpol'))
...
project = u'ximpol'
copyright = u'2015, the ximpol team'
...
latex_documents = [
  ('index', 'ximpol.tex', u'ximpol Documentation',
   u'The ximpol team', 'manual'),
]
...
man_pages = [
    ('index', 'ximpol', u'ximpol Documentation',
     [u'The ximpol team'], 1)
]
...
texinfo_documents = [
  ('index', 'ximpol', u'ximpol Documentation',
   u'The ximpol team', 'ximpol', 'One line description of project.',
   'Miscellaneous'),
]
