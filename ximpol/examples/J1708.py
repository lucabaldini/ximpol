...
"""
CFG_FILE_PATH = os.path.join(XIMPOL_CONFIG, 'J1708.py')
OUT_FILE_PATH_BASE = os.path.join(XIMPOL_DATA, 'J1708')
EVT_FILE_PATH = '%s.fits' % OUT_FILE_PATH_BASE
ANALYSIS_FILE_PATH = '%s_analysis.txt' % OUT_FILE_PATH_BASE
SIM_DURATION = 250000.
PHASE_BINNING = numpy.linspace(0., 1., 10)
...
def bin():
    ...
    for i, (_emin, _emax) in enumerate(_ebinning):
        ...
        PIPELINE.xpbin(_esel_file_path(i), algorithm='PHASG', phasebins=9 )
